...
const CompareCateringPackages = () => {
    ...
    useEffect(() => {
        axios
            .get(`/api/customer/CompareCatering?event_id=${event_id}`)
            .then((response) => {
    ...
    const handleAddtoEvent = (package_id)=>{
        axios.post(`/api/customer/addCateringtoEvent?pack_id=${package_id}&event_id=${event_id}`)
        .then((response)=>{
            ...
            <>
                <div>
                    ...
                    <h2 className="compare-title">
                        <b>Comparing Selected Catering Packages</b>
                    </h2>
                </div>
                <div>
                    <table className="compare-table">
                        <tr className="compare-table-row">
                            ...
                            <td className="compare-table-data">
                                <Link
                                    to={`/customer/event/Catering?event_id=${event_id}&packageCount=2&column=1`}
                                >
                            ...
                            <td className="compare-table-data">
                                <Link
                                    to={`/customer/event/Catering?event_id=${event_id}&packageCount=2&column=2`}
                                >
                                    <Button>Add Package To Compare</Button>
                                </Link>
                            </td>
                            <td className="compare-table-data">
                                <Link
                                    to={`/customer/event/Catering?event_id=${event_id}&packageCount=2&column=3`}
                                >
                                    <Button>Add Package To Compare</Button>
                                </Link>
                            </td>
                        ...
                        <tr className="compare-table-row">
                            <th className="compare-table-header">Menu</th>
                            <td className="compare-table-data">{data[0].package_menu}</td>
                            <td className="compare-table-data">{data[1].package_menu}</td>
                            {data[2] !== undefined ? (
                                <td className="compare-table-data">{data[2].package_menu}</td>
                            ) : (
                                <td className="compare-table-data"></td>
                            )}
                        </tr>
...
export default CompareCateringPackages;
