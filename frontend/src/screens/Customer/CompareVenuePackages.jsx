                ...
                <div>
                    <table className='compare-table'>
                        <tr className='compare-table-row'>
                            ...
                            <Link to={`/Venue?event_id=${event_id}&packageCount=2&column=1`}>
                                <Button>Add Package To Compare</Button>
                                </Link>
                            </td>
                            <td className='compare-table-data'>
                            <Link to={`/Venue?event_id=${event_id}&packageCount=2&column=2`}>
                                <Button>Add Package To Compare</Button>
                                </Link>
                            </td>
                            <td className='compare-table-data'>
                            <Link to={`/Venue?event_id=${event_id}&packageCount=2&column=3`}>
                                <Button>Add Package To Compare</Button>
                                </Link>
                            </td>
                        </tr>
                        ...
                        <tr className='compare-table-row'>
                            ...
                            <td className='compare-table-data'>
                            <Image src={`../../src/assets/images/uploads/${data[0].sp_images}`} thumbnail className="venueDesImg"/>
                            </td>
                            <td className='compare-table-data'>
                            <Image src={`../../src/assets/images/uploads/${data[1].sp_images}`} thumbnail className="venueDesImg"/>
                            </td>
                            <td className='compare-table-data'>
                            {data[2] !==undefined ?
                            <Image src={`../../src/assets/images/uploads/${data[2].sp_images}`} thumbnail className="venueDesImg" />:
                            <Image  thumbnail className="venueDesImg" style={{backgroundColor:'#b8a8b7'}}/>}
                            </td>
                        </tr>
                        <tr className='compare-table-row'>
                            <th className='compare-table-header'>Hall Name</th>
                            <td className='compare-table-data'>{data[0]. package_op_title}</td>
                            <td className='compare-table-data'>{data[1]. package_op_title}</td>
                            {data[2]!==undefined ?
                            <td className='compare-table-data'>{data[2]. package_op_title}</td>:
                            <td className='compare-table-data'></td>}
                        </tr>
                        ...
                        <tr className='compare-table-row'>
                            ...
                            {data[2]!==undefined ?
                            <td className='compare-table-data'>{data[2]. package_address}</td>:
                            <td className='compare-table-data'></td>}
                        </tr>
                        <tr className='compare-table-row'>
                        ...
                        <tr className='compare-table-row'>
                            ...
                            {data[2]!==undefined ?
                            <td className='compare-table-data'>{data[2]. package_op_count}</td>:
                            <td className='compare-table-data'></td>}
                        </tr>
                        <tr className='compare-table-row'>
                            ...
                            {data[2]!==undefined ?
                            <td className='compare-table-data'>{data[2].package_op_area}</td>:
                            <td className='compare-table-data'></td>}
                        </tr>
                        <tr className='compare-table-row'>
                            ...
                            {data[2]!==undefined ?
                            <td className='compare-table-data'>{data[2].package_op_type}</td>:
                            <td className='compare-table-data'></td>}
                        </tr>
