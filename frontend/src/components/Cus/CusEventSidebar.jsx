...
const CusEventSidebar = ({children}) => {
   ...
   const menuItem =[
    ...
    return (
        <div className="cusSidebar-Container">
            <div style={{width:isOpen ? "250px" : "50px", "margin-left":"-112px" ,"margin-top":"-8px"}} className="cusSidebar-sidebar">
...
export default CusEventSidebar;